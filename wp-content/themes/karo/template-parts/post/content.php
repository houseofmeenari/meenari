	...
	<?php if( $post_format != 'quote' ): ?>
		...
		<div class="post-info">
			...
			<?php if( $smof_data['ftc_blog_author'] ): ?>
				<span class="vcard author"><?php esc_html_e('Post by: ', 'karo'); ?><?php the_author_posts_link(); ?></span>
			<?php endif; ?>

			<!-- Blog Categories -->
			<?php if ( $categories_list && $smof_data['ftc_blog_categories'] ): ?>
				<div class="caftc-link">
					<span><?php esc_html_e('Categories: ', 'karo'); ?></span>
			...
			<span class="tags-link">
				<span><?php esc_html_e('Tags: ','karo');?></span>
...
<div class="entry-summary">
	...
	<?php if( $smof_data['ftc_blog_read_more'] ): ?>
		<a class="button-readmore" href="<?php the_permalink() ; ?>"><?php esc_html_e('Read More', 'karo'); ?></a>
	<?php endif; ?>
</div>
</div>
