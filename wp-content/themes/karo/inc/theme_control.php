...
function ftc_template_redirect(){
	...
	if( is_page() || is_tax( get_object_taxonomies( 'product' ) ) || is_post_type_archive('product') ){
		...
		if( trim($ftc_page_datas['ftc_primary_color']) != '' ){
			$smof_data['ftc_primary_color'] = $ftc_page_datas['ftc_primary_color'];
		}
		if( trim($ftc_page_datas['ftc_secondary_color']) != '' ){
			$smof_data['ftc_secondary_color'] = $ftc_page_datas['ftc_secondary_color'];
		}
		if( trim($ftc_page_datas['ftc_body_font_google']) != '' ){
			$smof_data['ftc_body_font_google']['font-family'] = $ftc_page_datas['ftc_body_font_google'];
		}
		if( trim($ftc_page_datas['ftc_body_font_family']) != '' ){
			$smof_data['ftc_body_font_family'] = $ftc_page_datas['ftc_body_font_family'];
		}
		if( trim($ftc_page_datas['ftc_secondary_body_font_google']) != '' ){
		...
		if( $ftc_page_datas['ftc_dark_layout'] ){
			add_filter('body_class', create_function('$classes', '$classes[] = "dark_layout"; return $classes;'));
		}
		if( $ftc_page_datas['ftc_box_layout'] ){
			add_filter('body_class', create_function('$classes', '$classes[] = "box_layout"; return $classes;'));
		}
