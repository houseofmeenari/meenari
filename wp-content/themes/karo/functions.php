...
$file_names = array('feedburner_subscription','instagram', 'products', 'product_filter_by_color', 'blogs', 'blogs_tabs', 'recent_comments', 'product_categories');
foreach ($file_names as $file) {
            ...
            <div class="ftc-cookies-popup">
                <div class="ftc-cookies-inner">
                    ...
                    <div class="cookies-buttons">
                        ...
                        <a href="#" class="btn btn-size-small btn-color-primary cookies-accept-btn"><?php esc_html_e( 'Yes, I\'m Accept ', 'karo' ); ?></a>
                    </div>
                </div>
            </div>
        <?php
...
function ftc_breadcrumbs_title($show_breadcrumb = false, $show_page_title = false, $page_title = '', $extra_class_title = '') {
    ...
    if ($show_breadcrumb || $show_page_title) {
        ...
        echo '<div class="ftc-breadcrumb" ' . $style . '><div class="ftc-breadcrumb-title container">';
        if ($show_page_title) {
