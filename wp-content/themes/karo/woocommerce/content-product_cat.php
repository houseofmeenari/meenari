...
<div <?php wc_product_cat_class('category-slider product-category product', $category); ?>>
    ...
    <div class="item-description">
        ...
        <?php
        if ($category->count > 0) {
            echo apply_filters('woocommerce_subcategory_count_html', '<div class="count-product-category"><span class="count-cate">'.sprintf(_n('%s Product',$category->count, 'karo'), $category->count).'</span>'. esc_html__('Products', 'karo') . '</div>', $category);
        }
        ?>
